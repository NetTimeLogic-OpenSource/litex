...
git_repos = {
    ...
    "litex":                           GitRepo(url="https://github.com/NetTimeLogic-OpenSource/", tag=True),
    ...
    # LiteX Boards.
    # -------------
    "litex-boards": GitRepo(url="https://github.com/NetTimeLogic-OpenSource/", clone="regular", tag=True),
